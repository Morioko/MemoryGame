...
function matchCards(icon1, icon2) {
    ...
    function shuffleCards(){
        ...
        let arr = ["bxl-tiktok", "bxl-instagram", "bxl-facebook", "bxl-twitter", "bxl-whatsapp", "bxl-youtube", "bxl-tiktok", "bxl-instagram", "bxl-facebook", "bxl-twitter", "bxl-whatsapp", "bxl-youtube"];
